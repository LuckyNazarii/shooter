...
#ініціалізація шрифтів та написів
font.init()
...
#нам необхідні наступні картинки:
...
max_lost = 3 #програли, якщо пропустили max_lost
...
class GameSprite(sprite.Sprite):
 ...
 #метод, для відрисування героя на вікні
   def reset(self):
...
class Enemy(GameSprite):
   ...
   def update(self):
       ...
       global lost
       #зникає, якщо доходить до межі екрану
...
#змінна "гру закінчено": як тільки там True, в основному циклі перестають працювати спрайти
finish = False
...
while run:
   ...
   if not finish:
       ...
       #обновляємо їх в новому місці при кожній ітерації циклу
       ship.reset()
 ...
 #перевірка зіткнення кулі та монстрів (і монстр, і куля при дотику зникають)
       ...
       #умови програшу: пропустили забагато або герой зіткнувся з ворогом
       if sprite.spritecollide(ship, monsters, False) or lost >= max_lost:
           finish = True #програли, ставим фон и більше не керуємо спрайтами.
